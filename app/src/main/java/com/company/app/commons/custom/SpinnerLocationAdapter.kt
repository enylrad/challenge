...
class SpinnerLocationAdapter(context: Context, val values: List<LocationEntity>) : ArrayAdapter<LocationEntity>(context, R.layout.adapter_spinner_custom, R.id.adapter_name, values) {
    override fun getCount(): Int = values.size

    override fun getItem(position: Int): LocationEntity? = values[position]
